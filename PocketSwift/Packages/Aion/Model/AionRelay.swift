...
public class AionRelay: Relay {
    ...
    init(netID: String, devID: String, method: String, params: [Any]?) throws {
        ...
        super.init(network: PocketAion.NETWORK, netID: netID, data: data, devID: devID, httpMethod: nil, path: nil, queryParams: nil, headers: nil)
    }
